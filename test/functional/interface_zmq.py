...
from test_framework.test_framework import ValueroTestFramework, SkipTest
...
class ZMQTest (ValueroTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that valuero has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("valuerod has not been built with zmq enabled.")
