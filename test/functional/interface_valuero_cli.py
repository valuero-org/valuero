...
class TestValueroCli(ValueroTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `valuero-cli getinfo`")
        ...
        self.log.info("Compare responses from `valuero-cli -getinfo` and the RPCs data is retrieved from.")
