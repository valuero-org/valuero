...
class TxnMallTest(ValueroTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 VAL:
        ...
        # First: use raw transaction API to send 1240 VAL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 VAL coin each
        ...
        # Node0's balance should be starting balance, plus 50VAL for another
        ...
        # Node0's total balance should be starting balance, plus 100VAL for 
