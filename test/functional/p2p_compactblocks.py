...
# TestNode: A peer we use to send messages to valuerod, and store responses.
...
class CompactBlocksTest(ValueroTestFramework):
    ...
    # This test actually causes valuerod to (reasonably!) disconnect us, so do this last.
    ...
    # Test that valuerod requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for valuerod to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # valuerod will not send blocktxn responses for blocks whose height is
