...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ValueroTestFramework
    pass

class ExampleTest(ValueroTestFramework):
    # Each functional test is a subclass of the ValueroTestFramework class.
    ...
    def custom_method(self):
        ...
        ValueroTestFramework class so other tests can use it."""
