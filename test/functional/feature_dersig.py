...
class BIP66Test(ValueroTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # valuerod is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and valuerod produces more specific reject
            # reasons.
