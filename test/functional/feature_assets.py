...
class AssetTest(ValueroTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating VAL for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.listassets(asset="VAL*", verbose=False, count=2, start=-2)
        ...
        valuero_assets = n0.listassets(asset="VAL*", verbose=False, count=2, start=-2)
        assert_equal(len(valuero_assets), 2)
        assert_equal(valuero_assets[0], "VAL2")
        assert_equal(valuero_assets[1], "VAL3")
        self.sync_all()
