...
By default, valuerod will dump mempool on shutdown and
...
class MempoolPersistTest(ValueroTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give valuerod a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent valuerod from writing mempool.dat to disk. Verify that `savemempool` fails")
