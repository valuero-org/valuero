## Valuero Metadata Specification

Additional fields may be added, but will be ignored by Valuero.
...
```
{
   ...
   "contract_signature": "<Valuero signed contract_hash>",
...
**forsale_price** - To give buyers an idea of the cost to own and admin the asset token.   Price followed by a space, followed by the currency.  Examples: "10000 VAL" or "0.3 BTC" or "50000 USD"  This might be parsed by token broker websites.
