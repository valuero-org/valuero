...
find ${DISTNAME}/bin -type f -executable -exec ../valuero/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../valuero/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/valuero/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/valuero/depends/SDKs/MacOSX10.11.sdk.tar.gz
