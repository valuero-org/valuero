...
This document provides guidelines for internationalization of the Valuero Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `valuero_en.ts` remains unchanged.
