Valuero Core version *2.2.2* is now available!!
==============

  <https://github.com/valuero-org/valuero/releases/tag/v2.2.2>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/valuero-org/valuero/issues>

To receive security and update notifications, please subscribe to:

  <https://valuero.org/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/Valuero-Qt` (on Mac)
or `valuerod`/`valuero-qt` (on Linux).
...
Valuero Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows 10(x64) and later. 32-bit versions of Windows,
and Windows XP are not supported.

Valuero Core should also work on most other Unix-like systems but is not
frequently tested on them.

Valuero Core has been tested with macOS 10.14 Mojave, but it is recommended that *developers*
...
- Enhancements for Valuero Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/valuero-org/valuero/commits/release_2.2.2>
...
- Most importantly - The Valuero Community!
- Tron Black
- Jesse Empey
- Jeremy Anderson
- Corbin Fox
