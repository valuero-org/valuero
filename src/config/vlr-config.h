/* src/config/valuero-config.h.  Generated from valuero-config.h.in by configure.  */
/* src/config/valuero-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Valuero Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Valuero Core"
...
#define PACKAGE_BUGREPORT "https://github.com/valuero-org/valuero/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Valuero Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Valuero Core 2.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "valuero"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://valuero.org/"
