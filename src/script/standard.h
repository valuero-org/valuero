...
#ifndef VAL_SCRIPT_STANDARD_H
#define VAL_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a valuero address
 */
...
/**
 * Generate a Valuero scriptPubKey for the given CTxDestination. Returns a P2PKH
