...
#ifndef VAL_QT_VALUNITS_H
#define VAL_QT_VALUNITS_H
...
/** Valuero unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ValueroUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ValueroUnits(QObject *parent);

    /** Valuero units.
      @note Source: https://en.valuero.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VAL,
...
typedef ValueroUnits::Unit ValueroUnit;

#endif // VAL_QT_VALUNITS_H
