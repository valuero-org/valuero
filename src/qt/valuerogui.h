...
#ifndef VAL_QT_VALGUI_H
#define VAL_QT_VALGUI_H
...
/**
  Valuero GUI main class. This class represents the main window of the Valuero UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ValueroGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ValueroGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ValueroGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a valuero wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
