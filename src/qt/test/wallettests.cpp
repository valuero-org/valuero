...
#include "qt/valueroamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ValueroAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_valuero-qt -platform xcb      # Linux
//     src/qt/test/test_valuero-qt -platform windows  # Windows
//     src/qt/test/test_valuero-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ValueroUnits::formatWithUnit(unit, balance, false, ValueroUnits::separatorAlways);
    ...
    // Amount input
    ValueroAmountField* amountInput = receiveCoinsDialog.findChild<ValueroAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: valuero:")) != -1);
