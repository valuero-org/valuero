...
#ifndef VAL_QT_GUIUTIL_H
#define VAL_QT_GUIUTIL_H
...
/** Utility functions used by the Valuero Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "valuero:" URI into recipient object, return true on successful parsing
