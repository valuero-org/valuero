...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(ValueroUnits::VAL),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(ValueroUnits::formatWithUnit(unit, balance, false, ValueroUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ValueroUnits::formatWithUnit(unit, unconfirmedBalance, false, ValueroUnits::separatorAlways));
    ui->labelImmature->setText(ValueroUnits::formatWithUnit(unit, immatureBalance, false, ValueroUnits::separatorAlways));
    ui->labelTotal->setText(ValueroUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, ValueroUnits::separatorAlways));
    ui->labelWatchAvailable->setText(ValueroUnits::formatWithUnit(unit, watchOnlyBalance, false, ValueroUnits::separatorAlways));
    ui->labelWatchPending->setText(ValueroUnits::formatWithUnit(unit, watchUnconfBalance, false, ValueroUnits::separatorAlways));
    ui->labelWatchImmature->setText(ValueroUnits::formatWithUnit(unit, watchImmatureBalance, false, ValueroUnits::separatorAlways));
    ui->labelWatchTotal->setText(ValueroUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, ValueroUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("VAL")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the VAL balance grid from expanding and looking terrible when asset balance is hidden
