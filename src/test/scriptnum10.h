...
#ifndef VAL_TEST_SCRIPTNUM10_H
#define VAL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Valuero Core 0.10.0, for cross-comparison.
 */
public:
